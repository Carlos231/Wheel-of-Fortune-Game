...
** Author: Carlos Lopez M
** Date: 2/15/2016
** Description: Wheel of fortune game with up to 3 players
** Input: Starting message, num of players and rounds, guesses.
** Output: hidden message, loop of players playing revealing message and giving them money.
********************************************************************/
#include <iostream>
#include <string>
#include <ctime>
